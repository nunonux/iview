    ...
    <div>
        <Tabs type="card">
          <TabPane label="默认大小">
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <Form-item label-for="date" label="选择日期" prop="date">
                    <Date-picker element-id="date" format="dd-MM-yyyy HH:mm" type="date" placeholder="选择日期" v-model="formValidate.date"></Date-picker>
                </Form-item>
                ...
                <Form-item label="选择日期">
                    <Row>
                        <Col span="11">
                        <Form-item prop="date">
                            <Date-picker type="date" format="dd-MM-yyyy HH:mm" placeholder="选择日期" v-model="formValidate.date"></Date-picker>
                        </Form-item>
                        </Col>
          ...
          <TabPane label="小表单">
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <Form-item label-for="date" label="选择日期" prop="date">
                    <Date-picker element-id="date" format="dd-MM-yyyy HH:mm" type="date" placeholder="选择日期" v-model="formValidate.date" size="small"></Date-picker>
                </Form-item>
                <Form-item label-for="cascader" label="级联选择" prop="cascader">
                ...
                <Form-item label="选择日期">
                    <Row>
                        <Col span="11">
                        <Form-item prop="date">
                            <Date-picker type="date" format="dd-MM-yyyy HH:mm" placeholder="选择日期" v-model="formValidate.date" size="small"></Date-picker>
                        </Form-item>
                        </Col>
                        <Col span="2" style="text-align: center">-</Col>
                        <Col span="11">
          ...
          <TabPane label="大表单">
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <Form-item label-for="date" label="选择日期" prop="date">
                    <Date-picker element-id="date" format="dd-MM-yyyy HH:mm" type="date" placeholder="选择日期" v-model="formValidate.date" size="large"></Date-picker>
                </Form-item>
                <Form-item label-for="cascader" label="级联选择" prop="cascader">
                ...
                <Form-item label="选择日期">
                    <Row>
                        <Col span="11">
                        <Form-item prop="date">
                            <Date-picker type="date" format="dd-MM-yyyy HH:mm" placeholder="选择日期" v-model="formValidate.date" size="large"></Date-picker>
                        </Form-item>
                        </Col>
                        <Col span="2" style="text-align: center">-</Col>
                        <Col span="11">
        ...
        <div style="margin: 100px">
            <form action="/">
                ...
                <DatePicker type="date" format="dd-MM-yyyy HH:mm" placeholder="选择日期" style="width: 200px" name="f6"></DatePicker>
