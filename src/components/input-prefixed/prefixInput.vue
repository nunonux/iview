    ...
    export default {
        ...
        methods: {
            ...
            handleInput (event) {
                ...
                if (this.prefixText) {
                    ...
                    value =  this.upperCase ? value.toString().toUpperCase() : value;
                    
                    if (value.length === valueLength || value === this.prefixText) {
                        this.$refs.input.value = this.prefixText;
                        this.currentValue = this.prefixText;
        ...
        watch: {
            value (val) {
                if(this.prefixText) {
                    ...
                    if (val && this.upperCase === true)
                        ...
                        this.setCurrentValue(val.toString());
                }
                else
            ...
            prefixText(newValue, oldValue) {
                ...
                if(this.currentValue === this.prefixText)
                    this.$emit('input', '');
                else
